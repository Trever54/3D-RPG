...
public class SkyboxShader extends ShaderProgram{
    ...
    protected void getAllUniformLocations() {
        ...
        location_fogColour = super.getUniformedLocation("fogColour");
        location_cubeMap = super.getUniformedLocation("cubeMap");
        location_cubeMap2 = super.getUniformedLocation("cubeMap2");
        location_blendFactor = super.getUniformedLocation("blendFactor");
    }
